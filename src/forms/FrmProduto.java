...
public class FrmProduto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        query1 = java.beans.Beans.isDesignTime() ? null : entityManager1.createQuery("from Produto order by nomeproduto");
        ...
        cmbOrdem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Código", "Produto" }));
        ...
        lblPosicao.setText("Produto:");

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jTable1, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nomeproduto}"), txtPosicao, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jTable1, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.valor}"), jTextField2, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
        ...
        if (validaCampos()) {
            ...
            try {
                ...
                Produto produto = list1.get(linhaClicada);
                if(novo == true){
    ...
    private void atualizaGrid() {
        ...
        if (cmbOrdem.getSelectedItem().toString().equals("Código")) {
            ...
            if (cmbOrdem.getSelectedItem().toString().equals("Produto")) {
                ordem = "nomeproduto";
